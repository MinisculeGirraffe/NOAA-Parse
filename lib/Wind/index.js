...
export function parseWND(string) {
    ...
    return {
        direction: {
            value: parseNullInt(direction, "999"),
            unit: "degrees",
            quality: parseCodeMapping(directionQC, QualityCodes)
        },
        speed: {
            value: parseNullInt(speed, "9999"),
            unit: "Meters per Second",
            quality: parseCodeMapping(speedQC, QualityCodes)
        },
