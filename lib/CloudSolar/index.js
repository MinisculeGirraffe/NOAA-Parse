...
export function parseCIG(string) {
    ...
    return {
        height: {
            value: parseNullInt(height, "99999"),
            unit: "Meters",
...
export function parseGAx(string) {
    ...
    return {
        ...
        baseHeight: {
            value: parseNullInt(baseHeight, "+99999"),
            unit: "Meters",
            quality: parseCodeMapping(baseHeightQuality, QualityCodes)
        },
...
export function parseGE1(string) {
    ...
    return {
        ...
        baseHeightUpper: {
            value: parseNullInt(baseHeightUpper, "+99999"),
            unit: "Meters"
        },
        baseHeightLower: {
            value: parseNullInt(baseHeightLower, "+99999"),
            unit: "Meters"
        }
    }
}
...
export function parseGF1(string) {
    ...
    return {
        ...
        cloud_genus: {
            low: parseCodeMapping(lowCloudGenusCode, cloudGenusCodes.low),
            low_quality: parseCodeMapping(lowCloudGenusQuality, QualityCodes),
            mid: parseCodeMapping(midCloudGenusCode, (cloudGenusCodes.middle)),
            mid_quality: parseCodeMapping(midCloudGenusQuality, QualityCodes),
            high: parseCodeMapping(highCloudGenusCode, cloudGenusCodes.high),
...
export function parseGH1(string) {
    ...
    return {
        ...
        solar_rad_stddev_quality: parseCodeMapping(solar_rad_stddev_quality, QualityCodes),
    }
}
...
export function parseGJ1(string) {
    ...
    return {
        sunshine: {
            value: parseNullInt(sunshine_percent, "999"),
            unit: "percent",
            quality: parseCodeMapping(sunshine_percent_quality, QualityCodes)
        }
    }
}
...
export function parseGK1(string) {
    ...
    return {
        sunshine: {
            value: parseNullInt(sunshine_minutes, "99999"),
            unit: "minutes",
            quality: parseCodeMapping(sunshine_minutes_quality, QualityCodes)
        }
    }
}
...
export function parseGL1(string) {
    const [sunshine_month, sunshine_month_quality] = string.split(',')
    return {
        sunshine_month: {
            value: parseNullInt(sunshine_month, "99999"),
            unit: "minutes",
            quality: parseCodeMapping(sunshine_month_quality, QualityCodes)
        }
    }
}
...
export function parseGM1(string) {
    ...
    return {
        solar_irad_period: {
            value: parseNullInt(solar_irad_minutes, "9999"),
            unit: "minutes"
        },
        global_irad: {
...
export function parseGN1(string) {
    const [
        solar_rad_minutes,
        upwelling_solar_rad, upwelling_solar_rad_quality,
        downwelling_solar_rad, downwelling_solar_rad_quality,
        upwelling_infrared_rad, upwelling_infrared_rad_quality,
        photosynthetic_active_rad, photosynthetic_active_rad_quality,
        solar_zenith_angle, solar_zenith_angle_quality
    ] = string.split(",")
    return {
        solar_rad_period: {
            value: parseNullInt(solar_rad_minutes, "9999"),
            unit: "minutes"
        },
        upwelling_solar_rad: {
            value: parseNullInt(upwelling_solar_rad, "9999"),
            unit: "milli-watts per square meter",
            quality: parseCodeMapping(upwelling_solar_rad_quality, QualityCodes)
        },
        downwelling_solar_rad: {
            value: parseNullInt(downwelling_solar_rad, "9999"),
            unit: "milli-watts per square meter",
            quality: parseCodeMapping(downwelling_solar_rad_quality, QualityCodes)
        },
        upwelling_infrared_rad: {
            value: parseNullInt(upwelling_infrared_rad, "9999"),
            unit: "watts per square meter",
            quality: parseCodeMapping(upwelling_infrared_rad_quality, QualityCodes)
        },
        photosynthetic_active_rad: {
            value: parseNullInt(photosynthetic_active_rad, "9999"),
            unit: "watts per square meter",
            quality: parseCodeMapping(photosynthetic_active_rad_quality, QualityCodes)
        },
        solar_zenith_angle: {
            value: parseNullInt(solar_zenith_angle, "999"),
            unit: "angular degrees",
            quality: parseCodeMapping(solar_zenith_angle_quality, QualityCodes)
        }
    }
}
...
export function parseGP1(string) {
    const [
        net_solar_rad_period, net_solar_rad, net_solar_rad_quality,
        net_infrared_rad, net_infrared_rad_quality,
        net_rad, net_rad_quality
    ] = string.split(",")
    return {
        net_solar_rad_period: {
