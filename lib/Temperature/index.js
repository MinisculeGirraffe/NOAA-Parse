...
export function ParseTMP(input) {
    ...
    return {
        temperature: parseNullInt(tmpStr, "+9999", 10),
        temperature_unit: "Celsius",
        temperature_quality: parseCodeMapping(qc, QualityCodes)
    }
}
export function parseDEW(input) {
    const [tmpStr, qc] = input.split(',')
    return {
        dew_temperature: parseNullInt(tmpStr, "+9999", 10),
        dew_temperature_unit: "Celsius",
        dew_temperature_quality: parseCodeMapping(qc, QualityCodes)
    }
}
